...
const initialCategories = [
  ...
  { id: 'cat-rc', name: 'Premium Rice', slug: 'rice', type: 'rice', description: 'Export-grade long-grain and parboiled Basmati rice from Punjab.', imageUrl: '/images/rice.jpg', sortOrder: 3, _count: { products: 2 } },
