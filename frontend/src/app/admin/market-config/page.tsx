...
export default function MarketConfigPage() {
  ...
  if (!mounted) {
    return (
      <div className="flex items-center justify-center p-20 bg-[#fafbf9]">
  ...
  return (
    <div className="space-y-8 max-w-4xl font-sans relative z-10">
      <div>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="glass rounded-3xl p-5 border border-slate-200 bg-white shadow-sm flex flex-col justify-between card-hover">
          ...
          <div className="mt-4">
            <div className="text-[9px] text-slate-500 font-black uppercase tracking-wider">Premium Packaging Fee</div>
      ...
      <form onSubmit={handleSave} className="glass rounded-3xl p-6 border border-slate-200 bg-white shadow-sm space-y-6 text-xs font-semibold text-slate-700">
        <h3 className="text-xs font-black text-slate-850 uppercase tracking-wider border-b border-slate-100 pb-3.5">Update Market Multipliers</h3>

        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <label className="text-[10px] text-slate-500 uppercase font-black tracking-widest mb-1.5 block">USD to PKR Exchange Rate *</label>
            <div className="relative">
              <input
                ...
                className="w-full pl-3 pr-12 py-2.5 bg-white border border-slate-200 rounded-xl text-xs text-slate-850 font-medium focus:outline-none focus:ring-2 focus:ring-primary/20"
                required
              />
              <span className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[9px] font-black text-slate-400">PKR</span>
            </div>
          ...
          <div>
            <label className="text-[10px] text-slate-500 uppercase font-black tracking-widest mb-1.5 block">Premium Packaging Cost (PKR) *</label>
            <div className="relative">
              <input
                type="number"
        ...
        <div className="flex justify-end pt-4 border-t border-slate-100">
          <button
            type="submit"
            className="flex items-center gap-1.5 px-5 py-3 bg-gradient-to-r from-primary to-secondary hover:from-primary-hover hover:to-secondary-hover text-white font-extrabold rounded-xl text-xs uppercase tracking-wider transition-all shadow-md shadow-primary/10"
          >
            <Check size={14} />
            Save Configurations
          </button>
      ...
      <div className="glass rounded-3xl p-6 border border-slate-200 bg-white shadow-sm space-y-4">
        <h3 className="text-xs font-black text-slate-850 uppercase tracking-wider border-b border-slate-100 pb-3 flex items-center gap-1.5">
          <Landmark size={14} className="text-slate-600" /> Active Checkout Settings & Rules
        </h3>
        <div className="grid md:grid-cols-2 gap-6 text-xs leading-relaxed text-slate-500 font-semibold">
